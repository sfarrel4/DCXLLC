        ...
        <section class="content">
          <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Create New Employee User</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form role="form" action="/create-employee" method="post">
                  <div class="box-body">
					...
					<div class="form-group">
                      <label for="exampleInputPassword1">Employee Email Contact</label>
                      <input type="text" class="form-control" name="mainEmail" placeholder="Main Email">
                    </div>
					<div class="form-group">
                      <label for="exampleInputPassword1">Employee Phone Contact</label>
                      <input type="text" class="form-control" name="phoneNumber" placeholder="Phone Number">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Create Employee Username</label>
                      <input type="text" class="form-control" name="username" placeholder="Username">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Create Employee Password</label>
