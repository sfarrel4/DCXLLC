                    ...
                    <ul class="nav">
                        ...
                        <li>
                        		<form action="/logout" method="post">
                        			<a href="profile.jsp">Hello, <%=userName %>           </a><button type="submit" class="btn btn-primary">Sign Out</button>
                        		</form>
                        </li>
                    </ul>        
                </div><!--/.nav-collapse -->
...
<section class="main-info">
    <div class="container">
        <div class="row-fluid">
            <div class="span9">
                <h4>EMPLOYEE PAGE</h4>
                <p class="no-margin">We offer <strong>Free</strong> IT analysis to new costomers. Contact us at info@dcxllc.com</p>
            </div>
            <div class="span3"> </div>
        </div>
    </div>
...
<section id="services">
    <div class="container">
        <div class="center gap">
            <h3>What We Offer</h3>
            <p class="lead">Here is a look the services we provide</p>
        </div>
        ...
        <div class="row-fluid">
            <div class="span4">
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading">On-Site PC Repair</h4>
                        <p>Place holder information for pc repair</p>
                    </div>
                </div>
            </div>            
            ...
            <div class="span4">
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading">Network Solutions</h4>
                        <p>Placeholder for network solutions </p>
                    </div>
                </div>
            </div>            
            ...
            <div class="span4">
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading">Virus/Spyware Removal</h4>
                        <p>Placeholder for virus removal</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row-fluid">
            <div class="span4">
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading">Data Backup &amp; Revovery</h4>
                        <p>Placeholder for data back up.</p>
                    </div>
                </div>
            </div>            
            ...
            <div class="span4">
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading">VoIP Installation &amp; Configuration</h4>
                        <p>placeholder for VOIP description</p>
                    </div>
                </div>
            </div>            
            ...
            <div class="span4">
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading">Anual/Monthly Maintanace Agreements</h4>
                        <p>Place Holder </p>
                    </div>
                </div>
            </div>
            ...
            <div class="span3">
                ...
                <ul class="unstyled address">
                    ...
                    <li>
                        ...
                        <strong>Email: </strong> info@dcxllc.com
                    </li>
                    <li>
                        <i class="icon-globe"></i>
                        <strong>Website:</strong> www.dcxllc.com
                    </li>
                    <li>
...
<footer id="footer">
    <div class="container">
        <div class="row-fluid">
            <div class="span5 cp">
                &copy; DirectConnex LLC All Rights Reserved.
            </div>
            <!--/Copyright-->
