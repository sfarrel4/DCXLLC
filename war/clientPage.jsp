...
<html>
  <head>
    ...
    <title>DCXLLC | Client Portal</title>
          ...
          <div class="row">
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-aqua">
                <div class="inner">
                  <h3><%=clientTickets.size() %></h3>
                  <p>Open Tickets</p>
                </div>
                <div class="icon">
                  <i class="ion ion-person-stalker"></i>
                </div>
                <a href="viewOpenTickets.jsp" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
          </div><!-- /.row -->
