...
<html>
  <head>
    ...
    <title>DCXLLC | Employee Tickets</title>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
           <%
			...
			<div class="box">
             ...
             <%
             	for(int i = 0; i<o.size(); i++){
             		ticketNumber = o.get(i).getTicketNumber();
             		issueDate = o.get(i).getDateIssued();
             		issueCategory = o.get(i).getIssueCategory();
             		issueDescription = o.get(i).getIssueDescription();
             		ticketID = o.get(i).getTicketID();
             		companyName = o.get(i).getCompanyName();
             		
             	
             	%>
             	<tr>
             		<td><input type="checkbox" name="ticketIDs" value=<%=ticketID %>></td>
             		<td><a href="updateTicket.jsp?ticketID=<%=ticketID%>"><%=ticketNumber %></a></td>
             		<td><%=companyName %></td>
             		<td><%=issueDate %></td>
             		<td><%=issueCategory %></td>
			...
			<input type="submit" value="Close Tickets">
            </form>
